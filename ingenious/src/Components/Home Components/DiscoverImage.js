    ...
    return (
        <div className='relative w-full h-[600px] '>
           ...
           <div className="absolute inset-0 flex items-center justify-center text-center flex-col gap-2">
            <h1 className="text-white text-6xl font-extrabold uppercase">Join our community of fashion enthusiasts</h1>
    <h1 className="text-white text-3xl font-semibold">Discover exclusive brands and services in your area.</h1>
  </div>
        </div>
    )
}