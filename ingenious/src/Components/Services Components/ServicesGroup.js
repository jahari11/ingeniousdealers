...
export default function ServicesGroup (){
    ...
    return (
        ...
        <div className='relative w-full h-[600px] '>
           ...
           <h1 className="text-white text-7xl font-extrabold uppercase">Discover exclusive services in your area</h1>
    <h1 className="text-white text-5xl font-semibold">Hire a professional service provider near you.</h1>
  </div>
        </div>
        </>
    )
